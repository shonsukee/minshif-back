...
ActiveRecord::Schema[7.0].define(version: 2024_11_14_140959) do
  create_table "auth_codes", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "business_hours", charset: "utf8mb3", comment: "営業時間情報", force: :cascade do |t|
  ...
  create_table "invitations", charset: "utf8mb3", comment: "招待情報", force: :cascade do |t|
  ...
  create_table "memberships", charset: "utf8mb3", comment: "所属情報", force: :cascade do |t|
    t.string "user_id", comment: "ユーザ情報の外部キー"
    t.string "store_id", comment: "店舗情報の外部キー"
  ...
  create_table "shift_change_requests", charset: "utf8mb3", comment: "シフト変更依頼情報", force: :cascade do |t|
  ...
  create_table "shift_submission_requests", charset: "utf8mb3", comment: "シフト提出依頼情報", force: :cascade do |t|
    t.string "store_id", comment: "店舗情報の外部キー"
  ...
  create_table "shifts", charset: "utf8mb3", comment: "シフト情報", force: :cascade do |t|
  ...
  create_table "special_business_hours", charset: "utf8mb3", comment: "特別営業日情報", force: :cascade do |t|
    t.string "store_id", comment: "店舗情報の外部キー"
  ...
  create_table "stores", id: :string, charset: "utf8mb3", comment: "店舗情報", force: :cascade do |t|
  ...
  create_table "templates", charset: "utf8mb3", comment: "シフトのテンプレート情報", force: :cascade do |t|
    t.string "user_id", comment: "ユーザ情報の外部キー"
    t.time "start_time", null: false, comment: "開始時間"
    t.time "end_time", null: false, comment: "終了時間"
    t.text "notes", comment: "備考"
  ...
  create_table "tokens", charset: "utf8mb3", comment: "トークン情報", force: :cascade do |t|
    t.string "user_id", comment: "ユーザ情報の外部キー"
  ...
  create_table "users", id: :string, charset: "utf8mb3", comment: "ユーザ情報", force: :cascade do |t|
